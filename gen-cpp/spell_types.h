...
class SpellRequest {
 public:
  ...
  SpellRequest(const SpellRequest&);
  SpellRequest& operator=(const SpellRequest&);
  SpellRequest() {
  }
  ...
  friend std::ostream& operator<<(std::ostream& out, const SpellRequest& obj);
};
...
class SpellResponse {
 public:
  ...
  SpellResponse(const SpellResponse&);
  SpellResponse& operator=(const SpellResponse&);
  SpellResponse() {
  }
  ...
  friend std::ostream& operator<<(std::ostream& out, const SpellResponse& obj);
};
